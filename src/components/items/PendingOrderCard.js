    ...
    return (
        <div className="flex flex-row space-x-2 justify-between w-full bg-green-600 rounded-lg p-2">
            ...
            <div className="flex flex-col items-center justify-center">
                <button onClick={() => {RejectPendingOrder()}} className="bg-red-600 hover:bg-red-700 active:bg-red-800 p-2 h-full w-20 text-white font-bold rounded-lg">
                    REJECT
                </button>
                <button onClick={() => {AcceptPendingOrder()}} className="bg-yellow-500 hover:bg-yellow-600 active:bg-yellow-700 p-2 w-20 h-full text-white font-bold rounded-lg">
                    ACCEPT
                </button>
            </div>
        </div>
